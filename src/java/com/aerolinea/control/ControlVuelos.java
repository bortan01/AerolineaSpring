...
import com.aerolinea.dao.AeropuertoDaoImp;
...
public class ControlVuelos implements Serializable {
    ...
    private AeropuertoDaoImp aeropuertoDaoImpl;
    ...
    public AeropuertoDaoImp getAeropuertoDaoImpl() {
        return aeropuertoDaoImpl;
    }

    public void setAeropuertoDaoImpl(AeropuertoDaoImp aeropuertoDaoImpl) {
